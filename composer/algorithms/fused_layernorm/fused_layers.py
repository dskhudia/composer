...
from transformers.models.bert.modeling_bert import BertIntermediate, BertOutput, BertSelfOutput, BertEmbeddings, BertPooler, BertPreTrainedModel
...
class BertFlashSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, cu_seqlens, max_seqlen_in_batch):
        ...
        context = flash_attn_unpadded_qkvpacked_func(qkv, cu_seqlens, max_seqlen_in_batch, self.p_dropout if self.training else 0.0)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, position_ids=None,
                output_all_encoded_layers=False, masked_tokens_mask=None, **kwargs):
